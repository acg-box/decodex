...
pub use self::{
	...
	managed_repository::{
		...
		MAX_REPOSITORY_ADMISSION_OBSERVATIONS, MAX_REPOSITORY_OBSERVATION_ROLES,
		MAX_REPOSITORY_COMMIT_MESSAGE_BYTES, MAX_REPOSITORY_REGISTRATION_ID_BYTES,
		...
		RepositoryGitRegistrationRole, RepositoryObservedObjectType,
		RepositoryObservationPath, RepositoryPathObservation,
		RepositoryPathRegistrationRole, RepositoryRegistrationId,
