...
GRANT EXECUTE ON FUNCTION decodex.read_continuation_plan_exact(uuid,bigint) TO decodex_runtime;
GRANT EXECUTE ON FUNCTION decodex.plan_continuation_exact(text,text,uuid,uuid,bigint,uuid,uuid,
	uuid,uuid,bytea,text,text,integer,integer,text,boolean,integer,text[],text[],bigint[],text[],
	bigint[],bigint[],text[],text[],text[],bigint[]) TO decodex_runtime;
