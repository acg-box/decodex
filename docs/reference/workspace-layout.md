...
| `plugins/decodex/` | Canonical installable Decodex lifecycle plugin source. It owns Decodex docs/OKF temporarily, semantic drift, research, issue briefing, planning, runtime ops, commit, and land. |
