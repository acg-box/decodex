...
| `plugins/decodex/` | Canonical installable Decodex plugin source and reusable agent-facing skills, including repo-work rules, docs drift, debugging, research challenge, review repair, verification, issue briefing, planning, manual CLI, automation, commit, land, and labels. |
