...
| `repo_source` | The repository documentation policy requires durable guidance to live in `docs/spec`, `docs/runbook`, `docs/reference`, or `docs/decisions`; `docs/research/` contains JSON research artifacts and remains non-authoritative until promoted. | [`docs/policy.md`](../policy.md) |
