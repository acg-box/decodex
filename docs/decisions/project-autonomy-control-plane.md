...
| `repo_source` | Decodex already keeps research latent until promotion and routes execution through Decision Contracts, Program Intake, validation, review, and landing. | [`../spec/loop-runtime.md`](../spec/loop-runtime.md) |
