...
drift_watch: [decodex recover ghost-lane, mcp_test_fixture_ghost_lane, runtime_recovery_required, runtime_recovery_blocked, authority_boundary_check, architecture_recovery_packet, architecture_recovery_started, architecture_recovery_terminal, loop_status]
