...
Purpose: Route agents to public-safe evidence concepts that support durable docs
claims without becoming implementation authority by themselves.
...
- Put public-safe proof here only when it needs durable reuse across multiple
  concepts.
