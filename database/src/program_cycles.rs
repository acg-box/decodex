...
impl SqliteStore {
	...
	#[allow(clippy::too_many_lines)] // Keep one atomic continuation transaction together.
	...
	#[allow(clippy::too_many_lines)] // Keep one atomic evidence and review transaction together.
...
#[allow(clippy::too_many_lines)] // Keep one complete Program aggregate readback together.
...
mod tests {
	...
	#[tokio::test]
	#[allow(clippy::too_many_lines)] // Keep one complete continuation and restart proof together.
