...
use decodex_protocol::{EntityId, WorkItemBoardCard, WorkItemBoardProjectId, WorkItemState};

use crate::composer_input::{ComposerEvent, ComposerInput, SubmitComposer};
use crate::ui_theme;
...
pub(crate) enum FactoryEvent {
	...
	StartCodexConversation { context: &'static str, message: String },
	OpenWorkItemConversation { conversation_id: EntityId },
}
