...
static IMAGES: LazyLock<[Arc<Image>; 25]> = LazyLock::new(|| {
	let sources: [&[u8]; 25] = [
		...
		include_bytes!("../../../assets/workspace-symbols/reset-card.png"),
		include_bytes!("../../../assets/workspace-symbols/account-info.png"),
