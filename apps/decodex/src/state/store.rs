...
#[derive(Clone, Debug)]
struct ProjectRunRecoveryCandidate {
	project_id: String,
	issue_id: String,
	run_id: String,
	attempt_number: i64,
...
fn project_run_recovery_candidates(
	state: &StateData,
	project_id: &str,
	issue_id: Option<&str>,
...
fn project_run_recovery_candidate_counts_as_project_run(
	state: &StateData,
...
fn project_run_status_from_recovery_candidate(
	state: &StateData,
	candidate: &ProjectRunRecoveryCandidate,
