...
use crate::{
	agent::codex_accounts::{
		CHATGPT_OAUTH_CLIENT_ID, CODEX_USER_AGENT, CodexAccountAuthFailure, CodexAccountLogin,
		DEFAULT_REFRESH_ENDPOINT, DEFAULT_USAGE_ENDPOINT, HTTP_TIMEOUT,
...
impl CodexAccountPool {
	...
	pub(super) fn new_with_fixed_account(
	...
	#[cfg(test)]
	pub(super) fn new_with_fixed_account_and_codex_auth_path(
		path: impl AsRef<Path>,
		usage_endpoint: impl Into<String>,
		refresh_endpoint: impl Into<String>,
		fixed_account: Option<&str>,
	...
	pub(super) fn proactive_refresh_record(
		&self,
		record: &mut AccountPoolRecord,
		now_unix_epoch: i64,
	...
	pub(super) fn probe_record_usage(
		&self,
	...
	pub(super) fn probe_record_profile(
		&self,
		record: &AccountPoolRecord,
