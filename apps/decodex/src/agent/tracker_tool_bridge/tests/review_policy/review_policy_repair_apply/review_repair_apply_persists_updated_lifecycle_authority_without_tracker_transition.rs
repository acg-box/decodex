...
#[test]
fn review_repair_apply_persists_updated_lifecycle_authority_without_tracker_transition() {
	...
	assert_eq!(transition_fixture.head_sha(), "18a20f7dfb9526e7421a5f095b1c6adec84e52d6");
