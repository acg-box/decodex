...
pub(in crate::agent::app_server::tests) fn phase_goal_fake_codex_script(
	turn_outputs: &[&str],
	goal_statuses: &[&str],
...
pub(in crate::agent::app_server::tests) fn phase_goal_fake_codex_script_with_notification_turn_mismatch(
	turn_outputs: &[&str],
	goal_statuses: &[&str],
	unsupported_goal_methods: &[&str],
