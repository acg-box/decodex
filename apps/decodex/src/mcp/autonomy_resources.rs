...
pub(super) fn mcp_autonomy_project_resource(
...
pub(super) fn mcp_autonomy_current_objective_resource(
	state_store: &StateStore,
	project_id: &str,
	objective_id: &str,
) -> crate::prelude::Result<Value, McpError> {
...
pub(super) fn mcp_autonomy_objective_version_resource(
	state_store: &StateStore,
	project_id: &str,
	objective_id: &str,
	version: &str,
...
pub(super) fn mcp_autonomy_signals_resource(
	state_store: &StateStore,
	project_id: &str,
) -> crate::prelude::Result<Value, McpError> {
	let signals = state_store
...
pub(super) fn mcp_autonomy_signal_resource(
	state_store: &StateStore,
	project_id: &str,
	signal_id: &str,
) -> crate::prelude::Result<Value, McpError> {
...
pub(super) fn mcp_autonomy_proposals_resource(
	state_store: &StateStore,
	project_id: &str,
) -> crate::prelude::Result<Value, McpError> {
	let proposals = state_store
...
pub(super) fn mcp_autonomy_proposal_resource(
	state_store: &StateStore,
	project_id: &str,
	proposal_id: &str,
) -> crate::prelude::Result<Value, McpError> {
...
pub(super) fn mcp_autonomy_evidence_resource(
	state_store: &StateStore,
	project_id: &str,
) -> crate::prelude::Result<Value, McpError> {
	let signals = state_store
