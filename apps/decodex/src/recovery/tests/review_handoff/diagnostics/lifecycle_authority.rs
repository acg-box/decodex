use crate::{
	...
	state::{ReviewLifecycleHandoffFixture, ReviewLifecycleTransitionFixture, StateStore},
};

#[test]
fn rebind_lifecycle_authority_write_failure_clears_partial_lifecycle_authority() {
	...
	let error = review_handoff::write_review_lifecycle_fixtures_with_rollback(
		&state_store,
		"pubfi",
		"issue-id",
		&handoff,
	...
	assert!(
		state_store
			.review_lifecycle_handoff_fixture("pubfi", "issue-id", branch_name)
