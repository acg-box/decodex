...
#[test]
fn rebind_validation_completes_current_existing_authority_state_transition() {
	...
	.expect("current lifecycle authority should allow state-only handoff completion");
