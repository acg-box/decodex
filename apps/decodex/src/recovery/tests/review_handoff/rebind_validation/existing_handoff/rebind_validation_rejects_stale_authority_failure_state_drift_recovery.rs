...
#[test]
fn rebind_validation_rejects_stale_authority_failure_state_drift_recovery() {
	...
	.expect("stale existing lifecycle authority should require lifecycle authority refresh first");
	...
	.expect_err("stale lifecycle authority refresh must not repair failure-state drift");
