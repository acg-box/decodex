...
pub(in crate::orchestrator::status_render::run_rows::run) fn render_continuation_recovery_summary(
...
pub(in crate::orchestrator::status_render::run_rows::run) fn render_phase_acceptance_summary(
