...
pub(in crate::orchestrator::status_render::run_rows::run) fn render_run_protocol_event(
...
pub(in crate::orchestrator::status_render::run_rows::run) fn render_run_thread_active_flags(
	run: &OperatorRunStatus,
) -> String {
