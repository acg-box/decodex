...
fn classify_post_review_lane_blocks_landing_for_unresolved_authority_boundary() {
	...
	super::record_block_landing_authority_boundary(&state_store, &snapshot.issue);
	...
	super::record_clean_review_checkpoint_for_head(&state_store, &snapshot.issue.id, &head_oid);
...
fn classify_post_review_lane_requires_enhanced_evidence_for_authority_boundary() {
	...
	super::record_requires_enhanced_evidence_authority_boundary(&state_store, &snapshot.issue);
...
fn classify_post_review_lane_blocks_for_human_decision_authority_boundary() {
	...
	super::record_requires_human_authority_boundary(&state_store, &snapshot.issue);
