...
pub(super) fn run_activity_idle_timeout(marker: Option<&RunActivityMarker>) -> Duration {
...
pub(super) fn marker_process_is_alive(marker: &RunActivityMarker) -> bool {
	marker_process_liveness(marker).alive
}

pub(super) fn marker_process_liveness_for_marker(
	marker: &RunActivityMarker,
