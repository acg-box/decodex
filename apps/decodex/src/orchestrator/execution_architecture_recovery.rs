...
pub(super) use self::{
	decision::loop_guardrail_architecture_recovery_decision,
	events::architecture_recovery_retry_next_action,
};
...
use crate::{
	orchestrator::{
		...
		LoopGuardrailReason, LoopGuardrailRecoveryDecision, LoopGuardrailStopRequested, Path,
		RepoGateFailure, RepoGateFailureDisposition, Report, Result, ServiceConfig, StateStore,
		Value, git_guardrail_output, json, loop_guardrail_effective_status,
