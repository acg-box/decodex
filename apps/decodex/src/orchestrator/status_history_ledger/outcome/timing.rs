...
pub(in crate::orchestrator::status_history_ledger::outcome) fn history_ledger_timing(
...
pub(in crate::orchestrator::status_history_ledger::outcome) fn latest_history_ledger_text<F>(
	records: &[OperatorHistoryLedgerRecord],
	field: F,
) -> Option<String>
where
