use crate::orchestrator::{
	...
	prompting::{
		TRACKER_PUBLIC_TEXT_BOUNDARY_INSTRUCTION, prompting_contracts, prompting_recovery,
		prompting_review_guidance, prompting_workflow_context,
	},
};
	...
	T: IssueTracker + ?Sized,
{
	...
	let tracker_contract = match issue_run.dispatch_mode {
		...
		_ => format!(
			...
			continuation_guidance = continuation_guidance,
			pr_title = prompting_workflow_context::review_pull_request_title(&issue_run.issue),
			decodex_review_guidance =
