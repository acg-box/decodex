...
pub(super) struct HarnessOutcomeSignals {
	...
	pub(super) validation_failure_classes: std::collections::BTreeSet<String>,
	pub(super) review_statuses: std::collections::BTreeSet<String>,
	pub(super) accepted_finding_count: usize,
	pub(super) rejected_finding_count: usize,
	pub(super) nonclean_rounds: i64,
	pub(super) repair_phase_events: usize,
	pub(super) guardrail_reasons: std::collections::BTreeSet<String>,
	pub(super) authority_boundary_dispositions: std::collections::BTreeSet<String>,
