use crate::{
	execution_program::{
		ExecutionConflictDomain, ExecutionDependencySnapshot, ExecutionLinearIssueMapping,
		ExecutionProgram, ExecutionProgramNode, ExecutionReadinessState,
	},
	orchestrator::{
		self, ExecutionProgramReadinessContext, ExecutionProgramRecord, ExecutionWorkflowPolicy,
		IssueDispatchMode, IssueRunPlan, IssueTracker, ProgramDispatchSelection, Result,
...
pub(crate) struct RefreshedExecutionProgram {
	...
	pub(crate) issues_by_node: std::collections::BTreeMap<String, ProgramIssueSnapshot>,
}
