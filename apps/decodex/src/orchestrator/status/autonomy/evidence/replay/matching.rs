...
pub(in crate::orchestrator::status::autonomy::evidence::replay) fn operator_autonomy_matching_pr_review<
	'a,
>(
...
pub(in crate::orchestrator::status::autonomy::evidence::replay) fn operator_autonomy_pr_review_candidate_exists(
	event: &PrivateExecutionEvent,
	raw_source_refs: &[String],
...
pub(in crate::orchestrator::status::autonomy::evidence::replay) fn operator_autonomy_replay_evidence_matches(
	payload: &Value,
	proposal_id: &str,
