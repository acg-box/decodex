use super::{
	...
	git_guardrail_output, json, loop_guardrail_effective_status,
	loop_guardrail_worktree_fingerprint, record_authority_decision_request_private_event,
...
pub(in crate::orchestrator) fn architecture_recovery_retry_next_action(
	policy_decision: AuthorityBoundaryPolicyDecision,
) -> &'static str {
	match policy_decision {
		AuthorityBoundaryPolicyDecision::AutoContinue =>
