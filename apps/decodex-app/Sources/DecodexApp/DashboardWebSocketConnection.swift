...
actor DashboardWebSocketConnection {
	...
	private func sendHandshake(host: String, port: Int) async throws {
	...
	private func sendPong(_ payload: Data) async throws {
...
private final class DashboardConnectionResumeBox: @unchecked Sendable {
