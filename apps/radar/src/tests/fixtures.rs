...
pub(in crate::tests) fn valid_bundle() -> Value {
	serde_json::json!({
...
pub(in crate::tests) fn valid_signal() -> Value {
	serde_json::json!({
...
pub(in crate::tests) fn valid_config_feature_catalog() -> Value {
	serde_json::json!({
...
pub(in crate::tests) fn valid_release_delta() -> Value {
	serde_json::json!({
...
pub(in crate::tests) fn release(tag_name: &str, prerelease: bool) -> Value {
	serde_json::json!({
		"tag_name": tag_name,
		"name": tag_name,
		"published_at": "2026-06-01T00:00:00Z",
...
pub(in crate::tests) fn compare() -> Value {
	serde_json::json!({
		"status": "ahead",
		"ahead_by": 1,
		"total_commits": 1,
...
pub(in crate::tests) fn valid_review_queue() -> Value {
	serde_json::json!({
...
pub(in crate::tests) fn valid_queue_subject() -> Value {
	serde_json::json!({
		"subject_kind": "pr",
		"subject_id": "22414",
		"title": "Add Unix socket endpoint support",
...
pub(in crate::tests) fn valid_upstream_review() -> Value {
	serde_json::json!({
...
pub(in crate::tests) fn valid_upstream_impact() -> Value {
	serde_json::json!({
...
pub(in crate::tests) fn valid_control_plane_upgrade_candidate() -> Value {
	serde_json::json!({
...
pub(in crate::tests) fn valid_radar_archive_manifest() -> Value {
	serde_json::json!({
