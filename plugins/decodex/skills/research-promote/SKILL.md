...
- Promote into the correct knowledge owner: `docs/decisions` for rationale,
  `docs/spec` for normative truth, `docs/reference` for current state, `docs/runbook`
  for procedures, `docs/evidence` for reusable proof, skills/code/tests for behavior,
