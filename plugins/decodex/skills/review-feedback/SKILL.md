...
description: Use when receiving, triaging, validating, or repairing PR review comments, review summaries, CI/review bot output, Linear comments, or user-pasted feedback. Owns verified review repair, not review requests, commits, landing, or tracker closeout.
---
