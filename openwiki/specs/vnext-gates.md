...
This is the single integrated source-candidate matrix for the core freeze. It inventories the
...
| Regenerated schema and configured-authority digests | The canonical post-freeze derivation and final bound run agree on the V18 migration ledger, 73 relations, 67 safety functions, 138 triggers, all function source/metadata/signatures, ACLs, enum labels, constraints, indexes, dependencies, schema manifest, configured-authority inventory, and expected digests for the exact integrated tree. |
