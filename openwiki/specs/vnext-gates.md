...
This source-only matrix is deferred to the unified post-freeze gate. It binds V10-V19, the strict
...
The `fd1e351` core freeze is reopened only for the forward V19 time-authority repair and refreezes
at the approved V19 tree. This is the single integrated source-candidate matrix for that refrozen
core. It inventories the
