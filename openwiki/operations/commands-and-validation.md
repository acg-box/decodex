...
The PostgreSQL integration harness bootstraps the shipped three-migration history (`V1`
foundation, `V2` claim indexes, and forward-only `V3` Conversation history), verifies
