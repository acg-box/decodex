...
1. It checks the full V1-V30 migration syntax, applies and canonically provisions a fresh
   full ledger, and separately verifies the closed migration-only authority delta from V24
   through V30. V28, V29, and the V30 exact-build/profile repair do not derive or grant a runtime
...
3. It verifies the generated schema and configured-authority digests, including the exact 26
